...
struct idevicerestore_client_t {
	...
	char *yonkersfwdata[16];
	size_t yonkersfwdatasize[16];
	char *rosefwdata;
    ...
    char *baobabfwdata;
	size_t baobabfwdatasize;
    char *timerfwdata;
	size_t timerfwdatasize;
    char *rtimerfwdata;
	size_t rtimerfwdatasize;
	char *bbfwtmp;
	char *sepfwdata;
	size_t sepfwdatasize;
	char *cryptex1sysosdata;
	size_t cryptex1sysosdatasize;
	char *cryptex1sysvoldata;
	size_t cryptex1sysvoldatasize;
	char *cryptex1systcdata;
	size_t cryptex1systcdatasize;
	char *cryptex1apposdata;
	size_t cryptex1apposdatasize;
	char *cryptex1appvoldata;
